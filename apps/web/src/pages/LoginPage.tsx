  ...
  return (
    <AuthSplitLayout>
      ...
      <div className="mb-8 border-b border-slate-100 pb-5">
        <h2 className="text-xl font-bold text-slate-900 tracking-tight">Sign in to the portal</h2>
        <p className="mt-1.5 text-[13px] text-slate-500">Use your official credentials to continue.</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 text-center">
          <p className="text-[13px] text-slate-500">
            No account? <Link to="/register" className="font-semibold text-brand hover:text-brand-dark hover:underline underline-offset-4">Register</Link>
          </p>
        </div>
      </form>
    </AuthSplitLayout>
